...
export async function POST(request: Request) {
  ...
  // Idempotent: if org+company already exists, return it
  ...
  const { data: company, error: companyError } = await admin
    ...
    .insert({
      ...
      digitalization_level: Number(body.digitalization_level) || 1,
      innovation_level: Number(body.innovation_level) || 1,
      sustainability_score: Number(body.sustainability_score) || 1,
